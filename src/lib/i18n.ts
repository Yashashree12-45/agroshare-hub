  ...
  en: {
    translation: {
      ...
      operator: {
        ...
        jobs: 'jobs',
        perHour: '/hour',
        noOperatorsAvailable: 'No operators available for this equipment',
        checkBackLater: 'Check back later or proceed without operator',
        showingAllOperators: 'Showing all available operators',
        certifications: 'Certifications',
        welcome: 'Welcome',
        dashboardSubtitle: 'Manage your jobs and track earnings',
        ...
        reviews: 'Reviews',
        pendingRequests: 'Pending Requests',
        noRequests: 'No job requests at the moment',
        decline: 'Decline',
        accept: 'Accept',
        completedJobsList: 'Completed Jobs',
      ...
      register: {
        farmer: 'Farmer',
        farmerDesc: 'Rent equipment for your farm',
        owner: 'Owner',
        ownerDesc: 'List your equipment for rent',
        operator: 'Operator',
        operatorDesc: 'Offer your services as an operator',
        subtitle: 'Create your account',
        iWantTo: 'I want to be a',
        fullName: 'Full Name',
        ...
        specializationsPlaceholder: 'Tractor, Harvester, Drone (comma separated)',
        hourlyRate: 'Hourly Rate',
        bio: 'Bio',
        bioPlaceholder: 'Tell farmers about your experience...',
        error: 'Error',
        fillRequired: 'Please fill in all required fields',
        operatorFieldsRequired: 'Please fill in operator details',
        accountCreated: 'Account Created',
        welcomeMessage: 'Welcome to AgroToolAccess!',
  ...
  hi: {
    translation: {
      ...
      operator: {
        ...
        jobs: 'काम',
        perHour: '/घंटा',
        noOperatorsAvailable: 'इस उपकरण के लिए कोई ऑपरेटर उपलब्ध नहीं',
        checkBackLater: 'बाद में फिर से जांचें या बिना ऑपरेटर के जारी रखें',
        showingAllOperators: 'सभी उपलब्ध ऑपरेटर दिखा रहे हैं',
        certifications: 'प्रमाणपत्र',
        welcome: 'स्वागत है',
        dashboardSubtitle: 'अपने काम प्रबंधित करें और कमाई ट्रैक करें',
        ...
        jobHistory: 'काम का इतिहास',
        reviews: 'समीक्षाएं',
        pendingRequests: 'लंबित अनुरोध',
        noRequests: 'इस समय कोई काम का अनुरोध नहीं',
        decline: 'अस्वीकार करें',
        accept: 'स्वीकार करें',
        completedJobsList: 'पूर्ण किए गए काम',
      ...
      register: {
        farmer: 'किसान',
        farmerDesc: 'अपने खेत के लिए उपकरण किराए पर लें',
        owner: 'मालिक',
        ownerDesc: 'अपने उपकरण किराए पर दें',
        operator: 'ऑपरेटर',
        operatorDesc: 'ऑपरेटर के रूप में अपनी सेवाएं दें',
        subtitle: 'अपना खाता बनाएं',
        iWantTo: 'मैं बनना चाहता हूं',
        fullName: 'पूरा नाम',
        ...
        agreeTerms: 'साइन अप करके, आप हमारी सहमति देते हैं',
        terms: 'सेवा की शर्तें',
        and: 'और',
        privacy: 'गोपनीयता नीति',
        operatorDetails: 'ऑपरेटर विवरण',
        location: 'स्थान',
        locationPlaceholder: 'अपना शहर, जिला दर्ज करें',
        experience: 'अनुभव (वर्ष)',
        experiencePlaceholder: 'अनुभव के वर्ष',
        specializations: 'विशेषज्ञता',
        specializationsPlaceholder: 'ट्रैक्टर, हार्वेस्टर, ड्रोन (अल्पविराम से अलग)',
        hourlyRate: 'प्रति घंटा दर',
        bio: 'परिचय',
        bioPlaceholder: 'किसानों को अपने अनुभव के बारे में बताएं...',
        error: 'त्रुटि',
        fillRequired: 'कृपया सभी आवश्यक फ़ील्ड भरें',
        operatorFieldsRequired: 'कृपया ऑपरेटर विवरण भरें',
        accountCreated: 'खाता बनाया गया',
        welcomeMessage: 'AgroToolAccess में आपका स्वागत है!',
        failed: 'पंजीकरण विफल',
  ...
  mr: {
    translation: {
      ...
      operator: {
        ...
        jobs: 'कामे',
        perHour: '/तास',
        noOperatorsAvailable: 'या उपकरणासाठी कोणताही ऑपरेटर उपलब्ध नाही',
        checkBackLater: 'नंतर पुन्हा तपासा किंवा ऑपरेटरशिवाय पुढे जा',
        showingAllOperators: 'सर्व उपलब्ध ऑपरेटर दाखवत आहे',
        certifications: 'प्रमाणपत्रे',
        welcome: 'स्वागत',
        dashboardSubtitle: 'तुमची कामे व्यवस्थापित करा आणि कमाई ट्रॅक करा',
        unavailable: 'अनुपलब्ध',
        ...
        jobHistory: 'कामाचा इतिहास',
        reviews: 'पुनरावलोकने',
        pendingRequests: 'प्रलंबित विनंत्या',
        noRequests: 'सध्या कोणत्याही कामाच्या विनंत्या नाहीत',
        decline: 'नाकारा',
        accept: 'स्वीकारा',
        completedJobsList: 'पूर्ण झालेली कामे',
      ...
      register: {
        farmer: 'शेतकरी',
        farmerDesc: 'तुमच्या शेतासाठी उपकरणे भाड्याने घ्या',
        owner: 'मालक',
        ownerDesc: 'तुमची उपकरणे भाड्याने द्या',
        operator: 'ऑपरेटर',
        operatorDesc: 'ऑपरेटर म्हणून तुमच्या सेवा द्या',
        subtitle: 'तुमचे खाते तयार करा',
        iWantTo: 'मला व्हायचे आहे',
        fullName: 'पूर्ण नाव',
        ...
        agreeTerms: 'साइन अप करून, तुम्ही आमच्या मान्य करता',
        terms: 'सेवा अटी',
        and: 'आणि',
        privacy: 'गोपनीयता धोरण',
        operatorDetails: 'ऑपरेटर तपशील',
        location: 'स्थान',
        locationPlaceholder: 'तुमचे शहर, जिल्हा टाका',
        experience: 'अनुभव (वर्षे)',
        experiencePlaceholder: 'अनुभवाची वर्षे',
        specializations: 'विशेषीकरण',
        specializationsPlaceholder: 'ट्रॅक्टर, हार्वेस्टर, ड्रोन (स्वल्पविरामाने विभक्त)',
        hourlyRate: 'तासाचा दर',
        bio: 'परिचय',
        bioPlaceholder: 'शेतकऱ्यांना तुमच्या अनुभवाबद्दल सांगा...',
        error: 'त्रुटी',
        fillRequired: 'कृपया सर्व आवश्यक फील्ड भरा',
        operatorFieldsRequired: 'कृपया ऑपरेटर तपशील भरा',
        accountCreated: 'खाते तयार झाले',
        welcomeMessage: 'AgroToolAccess मध्ये तुमचे स्वागत आहे!',
        failed: 'नोंदणी अयशस्वी',
